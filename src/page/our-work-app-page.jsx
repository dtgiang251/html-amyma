  ...
  return (
    <>
     ...
     <section ref={revealRef1} className="relative overflow-hidden bg-white">
              ...
              <div className="flex flex-col">
                ...
                <div className="apple-reveal delay-200 flex items-center gap-4">
                  ...
                  <ul className="m-0 p-0">
                    <li className="text-white text-xs leading-4 py-1 px-2 bg-[#FF9517] rounded-[4px] inline-block mr-2">App</li>
      ...
      <section ref={revealRef2} className="relative bg-[#ffffff]"> 
            ...
            <div className="relative mx-auto w-full"> 
              <div className="relative w-full">
                <div className="relative">
                     <img className="apple-reveal animate-hero-float" alt="" src="../h-img21.png"/> 
                </div>
              </div>
            </div>
        ...
        <div className="relative z-10 mx-auto py-8 lg:py-14">
          <div className="relative z-10 mx-auto max-w-[1440px] px-6 sm:px-8 lg:px-16 xl:px-[var(--navX,108px)] grid items-start gap-5 md:grid-cols-2 lg:gap-12">
            ...
            <div className="relative mx-auto w-full"> 
              <div className="relative w-full">
                <div className="relative">
                     <img className="apple-reveal animate-hero-float" alt="" src="../h-img22.png"/> 
                </div>
              </div>
            </div>
        ...
        <div className="relative z-10 mx-auto max-w-[1440px] px-6 py-16 sm:px-8 md:py-16 lg:px-16 lg:py-[108px] xl:px-[var(--navX,108px)]">
            <div className="grid grid-cols-12 gap-8 items-start mb-14">
              ...
              <div className="col-span-12 lg:col-span-3">
                <h3 className="apple-reveal font-dmSans text-[24px] leading-[40px] lg:text-[40px] lg:leading-[48px] font-bold tracking-[-2px] text-primaryBlue lg:mb-0">
                  The Objective
                </h3>
              </div>
              ...
              <div className="col-span-12 lg:col-span-9">
                <p className="apple-reveal delay-400 lg:max-w-[60ch] font-dmSans text-sm leading-[20px] lg:text-lg lg:leading-6 text-[#3C3C3C]">
            ...
            <img alt="" src="/h-img23.png"/>
        </div>
      </section>

      <section ref={revealRef4} className="relative overflow-hidden bg-white py-0">
